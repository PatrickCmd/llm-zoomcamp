...
with st.sidebar:
    ...
    with col1:
        ...
        st.write("")
        st.image("./assets/groq-logo.png", width=200)
    # with col2:
    ...
    model_option = st.selectbox("Select Model", ["Llama 4", "DeepSeek-R1"])
...
with col1:
    ...
    st.markdown("<h2 style='color: #0066cc;'> Llama 4 vs DeepSeek-R1 RAG Battle </h2>", unsafe_allow_html=True)
